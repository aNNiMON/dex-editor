           ...
           ///     System.out.println(""+currentCodeAddress);
            ...
            switch(instruction.getFormat()){
                ...
                case Format51l:
                    ...
                    writer.printIntAsDec(((SingleRegisterInstruction)instruction).getRegisterA());
                    writer.write(' ');
                    writer.write(String.valueOf(((LiteralInstruction)instruction).getLiteral()));
                    writer.write('\n');
                    break;
                case Format22x:
                ...
                case ArrayData:
                    {
                        ...
                        while(elements.hasNext()){
                            ...
                            for(int width=element.bufferIndex;width<element.elementWidth+element.bufferIndex;width++){
                                ...
                                ByteRenderer.writeUnsignedTo(writer,element.buffer[width]);
                                writer.write(' ');
                            }
                            writer.write('\n');
                        }
...
//                writer.flush();
    ...
    private static void writeInvokeRegister(IndentingWriter writer,Instruction instruction)throws IOException{
    ...
    private static void writeLabel(IndentingWriter writer,int off)throws IOException{
        writer.write(':');
        writer.write(LABEL);
    ...
    private static void writeKeyAndTarget(IndentingWriter writer,int key,int target)throws IOException{
    ...
    private static void writeToReferencedItem(IndentingWriter writer,Instruction instruction)throws IOException {
